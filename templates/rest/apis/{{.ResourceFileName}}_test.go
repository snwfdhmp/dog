...
func Test{{unexported .ResourceName}}(t *testing.T) {
	testdata.ResetDB()
	router := newRouter()
	Serve{{unexported .ResourceName}}Resource(&router.RouteGroup, services.New{{unexported .ResourceName}}Service(daos.New{{unexported .ResourceName}}DAO()))
