...
func buildRouter(logger *logrus.Logger, db *dbx.DB) *routing.Router {
	...
	{{unexported .ResourceName}}DAO := daos.New{{.ResourceName}}DAO()
	apis.Serve{{.ResourceName}}Resource(rg, services.New{{.ResourceName}}Service({{unexported .ResourceName}}DAO))
